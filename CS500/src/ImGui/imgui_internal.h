...
struct IMGUI_API ImRect
{
    ...
    void        Expand(const float bloomIterations)          { Min.x -= bloomIterations;   Min.y -= bloomIterations;   Max.x += bloomIterations;   Max.y += bloomIterations; }
    void        Expand(const ImVec2& bloomIterations)        { Min.x -= bloomIterations.x; Min.y -= bloomIterations.y; Max.x += bloomIterations.x; Max.y += bloomIterations.y; }
